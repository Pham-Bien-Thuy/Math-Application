...
public class PrePostProcessor {
     ...
     */
    public static ArrayList<ResultDetect> nonMaxSuppression(ArrayList<ResultDetect> boxes, int limit, float threshold) {
    ...
    public static ArrayList<ResultDetect> outputsToNMSPredictions(float[] outputs, float imgScaleX, float imgScaleY, float ivScaleX, float ivScaleY, float startX, float startY) {
        ...
        for (int i = 0; i< mOutputRow; i++) {
            if (outputs[i* mOutputColumn +4] > mThreshold) {
                ...
                ResultDetect result = new ResultDetect(cls, outputs[i*mOutputColumn+4], rect);
                results.add(result);
            }
        }
