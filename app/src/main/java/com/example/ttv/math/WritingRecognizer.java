...
public class WritingRecognizer {
    ...
    private int initialize() {
        // final String filesPath = mContext.getFilesDir().getAbsolutePath() + "/hdb";

        AssetManager assetManager = mContext.getAssets();
        final String filesPath = "hdb";

        try {
            InputStream inputStream = assetManager.open(filesPath);
...
//         final String filesPath = "com.example.ttv/hdb";
